    ...
    <section id="contact" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 font-heading">Informações de Contato</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/80">+55 (11) 1234-5678</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/80">contato@institutoibc.org</p>
                </div>
              </div>
          ...
          >
            <h3 className="text-2xl font-bold mb-6 text-gray-900 font-heading">Envie uma Mensagem</h3>
            ...
            <button
              type="submit"
              className="mt-6 w-full bg-primary text-white py-4 rounded-lg flex items-center justify-center gap-2 hover:bg-primary-dark transition-all group"
            >
